                    ...
                    <div class="navbar-nav mr-auto nav-edit">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="blog.html" class="dropdown-item">View Bể Bơi</a>
                                <a href="viewnui.html" class="dropdown-item">View Núi</a>
                                <a href="viewho.html" class="dropdown-item">View Hồ</a>
            ...
            <div class="owl-carousel">
                <div class="carousel-item ">
                    <div class="carousel-img">
                        <img src="img/baner.jpg" alt="Image" height="200px">
                    </div>
                    <div class="carousel-text">
                        <h3>Booking Homestay</h3>
                        <h1>Đặt phòng nhanh và đơn giản</h1>
                        <!-- <p>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-text">
                        <h3>Booking Homestay</h3>
                        <h1>Chất lượng dịch vụ tuyệt vời</h1>
                        <!-- <p>
        ...
        <div class="container">
            ...
            <div class="row slider-team">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="img/producttc.jpg" alt="Team Image">
                        </div>
                        <div class="team-text">
                            <h2 class="textct">View Bể Bơi</h2>
                            <p>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="team-item">
                        ...
                        <div class="team-text">
                            <h2 class="textct">View Núi</h2>
                            <p>
                                <span class="title-price">từ</span>
                                <span class="price-value">3.850.000₫</span>
                                <span class="title-price">Đêm</span>
                            </p>
                            <div class="button-link button-xs"><a href="viewnui.html">xem chi tiết <i class="fas fa-long-arrow-alt-right"></i></a>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="team-item">
                        ...
                        <div class="team-text">
                            <h2 class="textct">View Hồ</h2>
                            <p>
                                <span class="title-price">từ</span>
                                <span class="price-value">3.850.000₫</span>
                                <span class="title-price">Đêm</span>
                            </p>
                            <div class="button-link button-xs"><a href="viewho.html">xem chi tiết <i class="fas fa-long-arrow-alt-right"></i></a>
